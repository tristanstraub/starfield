...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.call(null,(function (p__2045){
var vec__2046 = p__2045;
var _ = cljs.core.nth.call(null,vec__2046,(0),null);
var v = cljs.core.nth.call(null,vec__2046,(1),null);
...
if(((((cljs.core.set_QMARK_.call(null,class$)) || (cljs.core.sequential_QMARK_.call(null,class$)))) && (cljs.core.every_QMARK_.call(null,(function (p1__2049_SHARP_){
return (((p1__2049_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__2049_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.call(null,G__2050,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__2050;
}
});
...
var len__4499__auto___2053 = arguments.length;
var i__4500__auto___2054 = (0);
while(true){
if((i__4500__auto___2054 < len__4499__auto___2053)){
args__4502__auto__.push((arguments[i__4500__auto___2054]));

var G__2055 = (i__4500__auto___2054 + (1));
i__4500__auto___2054 = G__2055;
continue;
} else {
}
break;
...
var G__2052 = cljs.core.reduce.call(null,cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if(!(cljs.core.empty_QMARK_.call(null,classes))){
return cljs.core.assoc.call(null,G__2052,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec.call(null,classes));
} else {
return G__2052;
}
} else {
...
/** @this {Function} */
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq2051){
var self__4487__auto__ = this;
return self__4487__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq2051));
});
...
var tag_name = cljs.core.nth.call(null,vec__2058,(0),null);
var names = cljs.core.nth.call(null,vec__2058,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css.call(null,cljs.core.some.call(null,((function (matches,vec__2058,tag_name,names){
return (function (p1__2056_SHARP_){
if(cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__2056_SHARP_))){
return p1__2056_SHARP_;
} else {
return null;
}
});})(matches,vec__2058,tag_name,names))
,names)),cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.comp.call(null,cljs.core.filter.call(null,((function (matches,vec__2058,tag_name,names){
return (function (p1__2057_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__2057_SHARP_));
});})(matches,vec__2058,tag_name,names))
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__2061){
var vec__2062 = p__2061;
var seq__2063 = cljs.core.seq.call(null,vec__2062);
var first__2064 = cljs.core.first.call(null,seq__2063);
var seq__2063__$1 = cljs.core.next.call(null,seq__2063);
var tag = first__2064;
var content = seq__2063__$1;
...
var vec__2065 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__2065,(0),null);
var id = cljs.core.nth.call(null,vec__2065,(1),null);
var class$ = cljs.core.nth.call(null,vec__2065,(2),null);
